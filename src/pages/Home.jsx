          ...
          {featuredProperties.map((property, index) => (
            ...
            >
              <div className="relative h-48">
                ...
                />
                <div className="absolute top-4 right-4 bg-white dark:bg-secondary-800 px-3 py-1 rounded-full text-primary-600 dark:text-primary-400 font-semibold">
                  {property.status}
                </div>
              </div>
              <div className="p-6">
          ...
          {blogPosts.map((post, index) => (
            ...
            >
              <Link to={`/blog/${post.slug}`}>
                ...
                <div className="p-6">
                  <h2 className="text-xl font-semibold mb-3 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                    {post.title}
                  </h2>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
            ...
            <div className="mt-12 lg:mt-0 flex justify-center">
              <div className="bg-white dark:bg-secondary-800 rounded-lg shadow-xl p-8 max-w-sm w-full">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-secondary-100 text-center mb-6">
                  Join Discord
                </h3>
                ...
                <p className="mt-4 text-sm text-gray-500 dark:text-secondary-300 text-center">
                  Already a member?{' '}
                  <a href="https://discord.gg/RentVerse" className="text-indigo-600 dark:text-indigo-300 hover:text-indigo-500 dark:hover:text-indigo-200">
                    Sign in
                  </a>
                </p>
              </div>
